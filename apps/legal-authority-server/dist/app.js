...
var init_index_esm = __esm({
  "../../node_modules/hash-wasm/dist/index.esm.js"() {
    ...
    getHashParameters = (password, encoded) => {
...
var require_dist = __commonJS({
  "../../packages/server-lib/dist/index.js"(exports, module2) {
    ...
    var import_hash_wasm = (init_index_esm(), __toCommonJS(index_esm_exports));
    var COST_FACTOR = 11;
    ...
    async function hashPassword({ password }) {
      ...
      const hash2 = await (0, import_hash_wasm.bcrypt)({
        password,
        salt,
    ...
    var import_express2 = require("iron-session/express");
    var SESSION_TTL = 15 * 24 * 3600;
    var createIronSession = ({ ...props }) => {
      return (0, import_express2.ironSession)({
        ttl: SESSION_TTL,
        cookieOptions: {
          httpOnly: true,
          ...props.cookieOptions
...
var builder = new import_core.default({
  ...
  smartSubscriptions: {
    ...(0, import_plugin_smart_subscriptions.subscribeOptionsFromIterator)((name2, ctx) => {
      return pubsub.subscribe(name2);
    })
  }
});
builder.queryType({
